# Documentation Team API overview template

Use this template to create your team API overview document. The overview defines how other teams work with your docs team, establishing clear expectations for collaboration, processes, deliverables, and timelines.

**How to use this template:**

- Replace example text with your team's specific information
- Keep the section structure intact - each section serves a critical purpose
- Delete items from tables or lists that don't apply to your organization
- Add additional items where your team needs more specificity
- For detailed guidance on each section, refer to the [Team API overview documentation](../docs/overview.md)
- See the [sample overview](../examples/sample-overview.md) for a complete example
